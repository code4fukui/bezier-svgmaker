...
- Automatically generate the SVG code for the created graphic
...
5. Click the "remove point" button to remove the last added control point.
6. Click the "toggle control point" button to show or hide the control points.
